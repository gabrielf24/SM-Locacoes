...
<!-- Barra de navegação com Página Inicial etc-->
        <ul class="nav col-12 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0">
          <li><a href="index.php" class="nav-link px-2 text-secondary">Página Inicial</a></li>
          <li><a href="quemsomos.php" class="nav-link px-2 text-white">Quem Somos</a></li>
    ...
    <div class="carousel-item active">
      ...
      <div class="container">
        <div class="carousel-caption text-start">
            <img src="img/produtos/mesas/mesa decorada 3.jpg" alt="mesa">
        </div>
      </div>
    </div>
...
<!-- Three columns of text below the carousel -->
  ...
  <div class="col-md-7">
    ...
    <div class="col-md-5">
      <figure class="mesa">
        <img src="img/produtos/mesas/mesa decorada 3.jpg" alt="balde-de-gelo" width="400px" height="400px">      
      </figure>
    </div>
  </div>
...
<footer class="d-flex flex-wrap justify-content-between align-items-center py-3 my-4 border-top">
  <div class="col-md-4 d-flex align-items-center">
    ...
    <span class="mb-3 mb-md-0 text-body-secondary">© SM Locações</span>
  </div>
